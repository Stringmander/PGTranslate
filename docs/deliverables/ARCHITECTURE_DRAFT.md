...
| `serve.py`                       |   586 |                                                                                                                                                                                                                                                                          | `config`, `imaging`, `ocr_providers`, `screen_translate`, `translation_providers`, `text_to_speech`, `util`, `bbox_extractor`, `webui.server` | Entry point. Also holds a second, threaded server path (`start_api_server`, :508) for a GUI window object absent from this codebase — inherited from upstream, unreachable, see finding 11.                       |
